...
//
const defaultNetwork = "testnet_bnb";
...
module.exports = {
  ...
  networks: {
    ...
    testnet_bnb: {
      ...
      accounts: { mnemonic: "output invite rude police twice sound fragile improve mercy pride trouble discover" }
    },
    mainnet_bnb: {
  ...
  etherscan: {
    ...
    apiKey: "43H8AEZP82YJJKIQ7F6ANQEQ6HM2WZZDYH"
  }
};
