...
import { NFTStorage } from "nft.storage/dist/bundle.esm.min";
...
export default function Minter({ customContract, account, gasPrice, signer, provider, name, price, blockExplorer }) {
